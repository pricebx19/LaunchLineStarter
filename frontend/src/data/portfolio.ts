...
export const FEATURED_PROJECTS: Project[] = [
  {
    ...
    technologies: [
      TECHNOLOGIES[0] || { id: 'react', name: 'React', category: { id: 'frontend', name: 'Frontend' } },
      TECHNOLOGIES[2] || { id: 'node', name: 'Node.js', category: { id: 'backend', name: 'Backend' } },
      TECHNOLOGIES[4] || { id: 'mongodb', name: 'MongoDB', category: { id: 'database', name: 'Database' } },
      TECHNOLOGIES[6] || { id: 'aws', name: 'AWS', category: { id: 'cloud', name: 'Cloud' } },
      TECHNOLOGIES[10] || { id: 'docker', name: 'Docker', category: { id: 'devops', name: 'DevOps' } }
    ],
    category: PROJECT_CATEGORIES[1] || { id: 'ecommerce', name: 'E-commerce', slug: 'ecommerce', description: 'Online shopping platforms' },
  ...
  },
  {
    ...
    technologies: [
      TECHNOLOGIES[1] || { id: 'vue', name: 'Vue.js', category: { id: 'frontend', name: 'Frontend' } },
      TECHNOLOGIES[2] || { id: 'node', name: 'Node.js', category: { id: 'backend', name: 'Backend' } },
      TECHNOLOGIES[5] || { id: 'postgresql', name: 'PostgreSQL', category: { id: 'database', name: 'Database' } },
      TECHNOLOGIES[7] || { id: 'azure', name: 'Azure', category: { id: 'cloud', name: 'Cloud' } },
      TECHNOLOGIES[9] || { id: 'kubernetes', name: 'Kubernetes', category: { id: 'devops', name: 'DevOps' } }
    ],
    category: PROJECT_CATEGORIES[0] || { id: 'healthcare', name: 'Healthcare', slug: 'healthcare', description: 'Medical and health-related applications' },
    status: { id: 'completed', name: 'Completed', color: '#10B981', description: 'Project successfully delivered' },
    client: CLIENTS[2]!,
...
export const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    project: FEATURED_PROJECTS[0] || {
      ...
      longDescription: 'A comprehensive e-commerce solution',
      image: '/images/portfolio/ecommerce-platform.jpg',
      images: [],
      technologies: [],
      category: { id: 'ecommerce', name: 'E-commerce', slug: 'ecommerce', description: 'Online shopping platforms' },
      status: { id: 'completed', name: 'Completed', color: '#10B981', description: 'Project successfully delivered' },
      client: { id: 'retailmax', name: 'RetailMax', industry: 'Retail', logo: '/images/clients/retailmax.png' },
      startDate: '2023-06-01',
      endDate: '2023-09-15',
      duration: '3.5 months',
      budget: '$45,000',
      ...
      liveUrl: 'https://retailmax.com',
      featured: true,
      seoTitle: 'E-commerce Platform Development',
      seoDescription: 'Modern e-commerce platform development'
    },
