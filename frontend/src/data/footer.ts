...
export const defaultFooterData: FooterData = {
  companyName: 'LaunchLine LLC',
  description: 'Professional web and software development that launches your business into the digital stratosphere. From startups to enterprise companies, we build the digital solutions that drive real results.',
