      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="col-span-1 md:col-span-2">
          <div class="flex items-center mb-4">
            <span class="text-2xl font-bold text-brand-primary">LaunchLine LLC</span>
          </div>
          <p class="text-gray-400 text-sm max-w-md mb-2">
            Professional web and software development that launches your business into the digital stratosphere. 
            From startups to enterprise companies, we build the digital solutions that drive real results.
          </p>
          <p class="text-brand-primary text-sm font-semibold italic">We're taking off.</p>
        </div>
        ...
        <div>
          ...
          <div class="space-y-2 text-sm">
            <p class="text-gray-400">hello@launchline.com</p>
